> [!IMPORTANT]
> Dokumen ini adalah referensi visual/frontend khusus yang sudah diterapkan ke web ini.
> File ini bukan dokumen onboarding umum proyek dan bukan jalur baca awal untuk semua agent.
> Jalur baca AI tetap mengikuti `AGENTS.md`.
